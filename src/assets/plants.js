export const plants = [
    ...
    },
    {
        ...
        description: 'A. myriostigma is a spineless cactus defined by the presence of three to seven (usually five) pronounced vertical ribs which define the cactus\' shape when young (the genus name "astrophytum", literally, "star plant", is derived from the resulting star-like shape). As the cactus ages, more ribs may be added and it becomes more cylindrical in shape, growing up to about 70–100 cm (2 ft 4 in–3 ft 3 in) tall and 10–20 cm (4–8 in) in diameter. In the wild, globose to cylindrical stem is covered with a whitish flocking of trichomes. Some horticultural varieties lack the flocking.',
        wiki: 'https://en.wikipedia.org/wiki/Astrophytum_myriostigma',
    },
    {
        id: 'golden-barrel',
    ...
    },
    {
        ...
        description: 'The saguaro is a columnar cactus that grows notable branches, usually referred to as arms. Over 50 arms may grow on one plant. Saguaros grow from 3–16 m (10–52 ft) tall, and up to 75 cm (30 in) in diameter. They are slow growing, but routinely live 150 to 200 years. They are the largest cactus in the United States.',
